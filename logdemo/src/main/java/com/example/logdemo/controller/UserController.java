...
public class UserController {
    ...
    public Object getAllUser() {
        ...
        try {
            ...
            log.error(e.getMessage(), e);//记录error
        }
        return result;
    }
    ...
    public Object getUserDetail(@PathVariable Long id) {
        log.info("获取指定用户id={}的信息",id);//参数占位格式 记录info
    ...
    public Object createUser(@RequestParam(value = "id", required = true) Long id,
        ...
        //参数占位格式 记录info
        log.info("添加用户信息为：id={},name={},mobile={},email={}",id,name,mobile,email);
        Map<String, Object> result = new HashMap<String, Object>();
        try {
            //不存在要添加的user信息 即可以添加
    ...
    public Object deleteUser(@PathVariable Long id) {
        log.info("删除指定用户id={}的信息",id);//参数占位格式 记录info
        Map<String, Object> result = new HashMap<String, Object>();
        try {
            User user = userService.getUser(id);
    ...
    public Object updateUser(@RequestParam(value = "id", required = true) Long id,
        ...
        //参数占位格式 记录info
        log.info("修改用户信息为：id={},name={},mobile={},email={}",id,name,mobile,email);
        Map<String, Object> result = new HashMap<String, Object>();
        try {
            //要修改的user存在
            if(userService.getUser(id) != null) {
